            ...
            <div class="bg-white rounded-lg shadow-md border border-gray-200 p-4 md:p-6 mb-6">
                ...
                <form method="POST" action="{{ route('admin.vouchers.store') }}" class="space-y-6" id="voucher-form">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
                        ...
                        <div class="md:col-span-2">
                            <div class="flex flex-col sm:flex-row gap-2 sm:gap-0">
                                ...
                                <button type="button"
                                    class="bg-gray-100 hover:bg-gray-200 text-gray-700 px-3 sm:px-4 py-2.5 sm:py-3 border border-gray-300 sm:border-l-0 rounded-lg sm:rounded-l-none sm:rounded-r-lg transition-colors duration-200 flex items-center justify-center"
                                    id="generate-code">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-start">
                        ...
                        <div class="md:col-span-2">
                            <textarea
                                ...
                                id="description" name="description" rows="3" placeholder="Masukkan deskripsi voucher">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
                        ...
                        <div class="md:col-span-2">
                            <select
                                class="w-full px-3 sm:px-4 py-2.5 sm:py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent @error('type') border-red-500 @enderror text-sm sm:text-base"
                                id="type" name="type">
                                <option value="">Pilih jenis diskon</option>
                                <option value="percentage" {{ old('type') == 'percentage' ? 'selected' : '' }}>Persentase
                                    (%)</option>
                                <option value="fixed_amount" {{ old('type') == 'fixed_amount' ? 'selected' : '' }}>Nominal
                                    (Rp)</option>
                                <option value="free_shipping" {{ old('type') == 'free_shipping' ? 'selected' : '' }}>Gratis
                                    Ongkir</option>
                            </select>
                            @error('type')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
                        ...
                        <div class="md:col-span-2">
                            <input type="number"
                                ...
                                id="usage_limit" name="usage_limit" value="{{ old('usage_limit') }}" placeholder="0"
                                min="1">
                            @error('usage_limit')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
        ...
        <div class="lg:col-span-1">
            ...
            <div class="bg-white rounded-lg shadow-md border border-gray-200 p-4 md:p-6 mb-6">
                ...
                <div class="border border-gray-200 rounded-lg p-4 bg-gray-50 text-center">
                    <div class="mb-3">
                        <svg class="w-10 h-10 sm:w-12 sm:h-12 mx-auto text-pink-600" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <p class="text-gray-500 text-xs sm:text-sm mb-3" id="preview-description">Deskripsi voucher akan
                        tampil di sini</p>
                    <div class="mb-3">
                        <span class="bg-green-100 text-green-800 text-xs sm:text-sm font-medium px-3 py-1 rounded-full"
                            id="preview-value">Diskon akan tampil di sini</span>
                    </div>
                    <div>
            ...
            <div class="bg-white rounded-lg shadow-md border border-gray-200 p-4 md:p-6">
                ...
                <ul class="space-y-3">
                    <li class="flex items-start">
                        <svg class="w-4 h-4 sm:w-5 sm:h-5 text-yellow-500 mr-2 mt-0.5 flex-shrink-0" fill="none"
                        ...
                        <div>
                            ...
                            <span class="text-gray-600 text-xs sm:text-sm">Gunakan kode yang mudah diingat dan
                                diketik</span>
                        </div>
                    </li>
                    <li class="flex items-start">
                        <svg class="w-4 h-4 sm:w-5 sm:h-5 text-pink-600 mr-2 mt-0.5 flex-shrink-0" fill="none"
                            stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div>
                            ...
                            <span class="text-gray-600 text-xs sm:text-sm">Berikan diskon yang cukup menarik untuk
                                customer</span>
                        </div>
                    </li>
                    <li class="flex items-start">
                        <svg class="w-4 h-4 sm:w-5 sm:h-5 text-blue-600 mr-2 mt-0.5 flex-shrink-0" fill="none"
                            stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div>
                            ...
                            <span class="text-gray-600 text-xs sm:text-sm">Buat urgency dengan membatasi periode
                                berlaku</span>
                        </div>
                    </li>
                    <li class="flex items-start">
                        <svg class="w-4 h-4 sm:w-5 sm:h-5 text-green-600 mr-2 mt-0.5 flex-shrink-0" fill="none"
                            stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div>
                            ...
                            <span class="text-gray-600 text-xs sm:text-sm">Kontrol budget dengan membatasi jumlah
                                penggunaan</span>
                        </div>
                    </li>
                </ul>
