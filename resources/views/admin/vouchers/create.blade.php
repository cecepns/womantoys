                ...
                <form method="POST" action="{{ route('admin.vouchers.store') }}" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
                        ...
                        <div class="md:col-span-2">
                            <div class="flex">
                                <input type="text" 
                                       class="flex-1 px-4 py-3 border border-gray-300 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent @error('code') border-red-500 @enderror" 
                                       id="code" name="code" value="{{ old('code') }}" 
                                       placeholder="Masukkan kode voucher" 
                                       style="text-transform: uppercase;">
                                <button type="button" class="bg-gray-100 hover:bg-gray-200 text-gray-700 px-4 py-3 border border-l-0 border-gray-300 rounded-r-lg transition-colors duration-200" id="generate-code">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
                        ...
                        <div class="md:col-span-2">
                            <select class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent @error('type') border-red-500 @enderror" id="type" name="type">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
                        ...
                        <div class="md:col-span-2">
                            <div class="flex">
                                <input type="number" 
                                       class="flex-1 px-4 py-3 border border-gray-300 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent @error('value') border-red-500 @enderror" 
                                       id="value" name="value" value="{{ old('value') }}" 
                                       placeholder="0" step="0.01" min="0">
                                <span class="px-4 py-3 bg-gray-50 border border-l-0 border-gray-300 rounded-r-lg text-gray-700" id="value-suffix">%</span>
                            </div>
                            @error('value')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
                        ...
                        <div class="md:col-span-2">
                            <div class="flex">
                                <span class="px-4 py-3 bg-gray-50 border border-gray-300 rounded-l-lg text-gray-700">Rp</span>
                                <input type="number" 
                                       class="flex-1 px-4 py-3 border border-l-0 border-gray-300 rounded-r-lg focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent @error('min_purchase') border-red-500 @enderror" 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-center hidden" id="max-discount-group">
                        ...
                        <div class="md:col-span-2">
                            <div class="flex">
                                <span class="px-4 py-3 bg-gray-50 border border-gray-300 rounded-l-lg text-gray-700">Rp</span>
                                <input type="number" 
                                       class="flex-1 px-4 py-3 border border-l-0 border-gray-300 rounded-r-lg focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent @error('max_discount') border-red-500 @enderror" 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div class="md:col-span-2">
                            <div class="flex flex-col sm:flex-row gap-3">
                                <button type="submit" class="bg-pink-600 hover:bg-pink-700 text-white font-medium py-2.5 md:py-3 px-4 md:px-8 rounded-lg transition-colors duration-200 flex items-center justify-center">
                                ...
                                <a href="{{ route('admin.vouchers.index') }}" class="bg-gray-600 hover:bg-gray-700 text-white font-medium py-2.5 md:py-3 px-4 md:px-6 rounded-lg transition-colors duration-200 text-center">
                                    Batal
                                </a>
                            </div>
                        </div>
        ...
        <div class="lg:col-span-1">
            ...
            <div class="bg-white rounded-lg shadow-md border border-gray-200 p-4 md:p-6 mb-6">
                ...
                <div class="border border-gray-200 rounded-lg p-4 bg-gray-50 text-center">
                    ...
                    <h5 class="font-bold text-lg text-gray-800 uppercase" id="preview-code">KODE VOUCHER</h5>
                    <p class="text-gray-700 mb-2" id="preview-name">Nama Voucher</p>
                    <p class="text-gray-500 text-sm mb-3" id="preview-description">Deskripsi voucher akan tampil di sini</p>
                    <div class="mb-3">
                        <span class="bg-green-100 text-green-800 text-sm font-medium px-3 py-1 rounded-full" id="preview-value">Diskon akan tampil di sini</span>
                    </div>
                    <div>
            ...
            <div class="bg-white rounded-lg shadow-md border border-gray-200 p-4 md:p-6">
                ...
                <ul class="space-y-3">
                    <li class="flex items-start">
                        ...
                        <div>
                            <strong class="text-gray-800">Kode yang Mudah Diingat:</strong> 
                            <span class="text-gray-600 text-sm">Gunakan kode yang mudah diingat dan diketik</span>
                        </div>
                    </li>
                    <li class="flex items-start">
                        ...
                        <div>
                            <strong class="text-gray-800">Nilai yang Menarik:</strong> 
                            <span class="text-gray-600 text-sm">Berikan diskon yang cukup menarik untuk customer</span>
                        </div>
                    </li>
                    <li class="flex items-start">
                        ...
                        <div>
                            <strong class="text-gray-800">Periode Terbatas:</strong> 
                            <span class="text-gray-600 text-sm">Buat urgency dengan membatasi periode berlaku</span>
                        </div>
                    </li>
                    <li class="flex items-start">
                        ...
                        <div>
                            <strong class="text-gray-800">Batasi Penggunaan:</strong> 
                            <span class="text-gray-600 text-sm">Kontrol budget dengan membatasi jumlah penggunaan</span>
                        </div>
                    </li>
                </ul>
            </div>
